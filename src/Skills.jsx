...
const Skills = () => {
  ...
  return (
    <div className=" relative font-roboto  pt-14 px-2 pl-10 min-h-screen  ">
      <ul
        className=" lg:text-xl flex  flex-col space-y-28 leading-7 tracking-widest  h-[calc(100vh-300px)] overflow-y-auto"
        style={{
      ...
      >
        {skillList.map((skill) => (
          <div
            key={skill.id}
            className="text-justify font-roboto  font-normal  lg:w-[70%] text-wrap"
          >
